...
# 		print OUT "cat /storage/scratch2/ss1293/22.Yosef_RNAseq_PhyB/RAW_fastq/$a /storage/scratch2/ss1293/22.Yosef_RNAseq_PhyB/RAW_fastq/$c > STAR_Alignment$sample/Read1.fastq.gz\n";
# 		print OUT "cat /storage/scratch2/ss1293/22.Yosef_RNAseq_PhyB/RAW_fastq/$b /storage/scratch2/ss1293/22.Yosef_RNAseq_PhyB/RAW_fastq/$d > STAR_Alignment$sample/Read2.fastq.gz\n";
...
# 		print OUT "rm STAR_Alignment$sample/*.fastq.gz\n";
...
foreach my $i (@file1)
	{
		...
		print OUT "/home/sohamsengupta/Downloads/FastQC/fastqc /media/sohamsengupta/easystore/RNAseq_Yosef_Sep2021/raw_data/$i/$i\_1.fq.gz\n";
		print OUT "/home/sohamsengupta/Downloads/FastQC/fastqc /media/sohamsengupta/easystore/RNAseq_Yosef_Sep2021/raw_data/$i/$i\_2.fq.gz\n";
		print OUT "mv /media/sohamsengupta/easystore/RNAseq_Yosef_Sep2021/raw_data/BN1/*fastqc* FASTqc\n";
		print OUT "cd FASTqc\n";
		print OUT "unzip *.zip\n";
		print OUT "rm *.zip\n";
		print OUT "cd ..\n";
		...
		print OUT "mkdir STAR_Alignment$i\n";
		print OUT "STAR --runThreadN 4 --readFilesCommand zcat --quantMode GeneCounts --genomeDir /media/sohamsengupta/DATAPART1/RNAseq_Sara_Oct2017/Arabidopsis_genomeTAIR10/genome_index  --outFileNamePrefix STAR_Alignment$i/ --readFilesIn /media/sohamsengupta/easystore/RNAseq_Yosef_Sep2021/raw_data/$i/$i\_1.fq.gz /media/sohamsengupta/easystore/RNAseq_Yosef_Sep2021/raw_data/$i/$i\_2.fq.gz\n";
